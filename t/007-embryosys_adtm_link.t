...
main(_) ->
    ...
    etap:is(embryosys_adtm_link:create("Bridge", "River", "cross"), {ok, {adt, {meta, link, ["Bridge", "River", "cross"], alive},[]}}, "Creating Link Bridge-cross-River"),

    % Changing the adt state
    etap:is(embryosys_adtm_link:hibern("Bridge", "River", "cross"), {ok, {adt, {meta, link, ["Bridge", "River", "cross"], frozen},[]}}, "Freezing Link Bridge-cross-River"),
    etap:is(embryosys_adtm_link:awake("Bridge", "River", "cross"), {ok, {adt, {meta, link, ["Bridge", "River", "cross"], alive},[]}}, "Unfreezing Link Bridge-cross-River"),
    etap:is(embryosys_adtm_link:destroy("Bridge", "River", "cross"), {ok, {adt, {meta, link, ["Bridge", "River", "cross"], destroyed},[]}}, "Destroying Link Bridge-cross-River"),
    etap:is(embryosys_adtm_link:resur("Bridge", "River", "cross"), {ok, {adt, {meta, link, ["Bridge", "River", "cross"], alive},[]}}, "Resurecting Link Bridge-cross-River"),

    % Try to create an link in a class that doesnt exist
    etap:is(embryosys_adtm_link:create("Nope", "River", "cross"), {wrong_state, []}, "Can't create Nope-cross-River"),
    etap:is(embryosys_adtm_link:create("Bridge", "Nope", "cross"), {wrong_state, []}, "Can't create Bridge-cross-Nope"),
    etap:is(embryosys_adtm_link:create("Nope", "Nope", "cross"), {wrong_state, []}, "Can't create Nope-cross-Nope"),

    % Try to recreate the same link in the same class
    etap:is(embryosys_adtm_link:create("Bridge", "River", "cross"), {wrong_state, []}, "Can't create the same link twice"),
